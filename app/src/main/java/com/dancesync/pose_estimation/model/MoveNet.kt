...
==============================================================================
*/
package com.dancesync.pose_estimation.model
...
import com.dancesync.pose_estimation.data.*
...
class MoveNet(private val interpreter: Interpreter, private var gpuDelegate: GpuDelegate?) :
    ...
    companion object {
        ...
        // TFLite file names.
        private const val LIGHTNING_FILENAME = "movenet_lightning.fp16.tflite"
    ...
    override fun estimatePoses(bitmap: Bitmap): List<Skeleton> {
        ...
        return listOf(Skeleton(keypoints = keypoints, score = totalScore / numKeyPoints))
    }
